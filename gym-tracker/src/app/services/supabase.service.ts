...
export class SupabaseService {
  ...
  //   exercise_id uuid null default gen_random_uuid (),
  ...
  //   constraint exercise_progress_exercise_id_fkey foreign KEY (exercise_id) references exercises (id),
  //   constraint exercise_progress_user_id_fkey foreign KEY (user_id) references auth.users (id),
  //   constraint exercise_progress_workout_id_fkey foreign KEY (workout_id) references workout_plans (id)
